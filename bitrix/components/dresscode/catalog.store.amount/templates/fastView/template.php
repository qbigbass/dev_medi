						...
						<table class="storeTableList">
							...
							<tr>
								...
								<?foreach($arResult["STORES"] as $pid => $arProperty):?>
									...
									<?else:?>
										<tr>
											<td class="name"><a href="<?=$arProperty["DETAIL_PAGE_URL"]?>"><span><?=$arProperty["TITLE"]?></span><?if ($arProperty['ADDRESS'] != ""){?><br/><span class="store_address"><?=$arProperty['ADDRESS']?></span><?}?></a></td>
