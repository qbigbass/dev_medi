...
if (!defined('BX_YMAP_SCRIPT_LOADED'))
{
	...
	$arResult['MAPS_SCRIPT_URL'] = $scheme.'://api-maps.yandex.ru/'.$arParams['YANDEX_VERSION'].'/?load=package.full&mode=release&lang='.$arParams['LOCALE'].'&wizard=bitrix&apikey=391d1c41-5055-400d-8afc-49ee21c8f4a1';
