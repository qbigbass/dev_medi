			...
			<div id="elementContainer" class="column">
										...
										<?else:?>
											<div class="elementSkuProperty" data-name="<?=$propName?>" data-level="<?=$level++?>" data-highload="<?=$arNextProp["HIGHLOAD"]?>">
                                                ...
                                                if ($propName=='SIZE' && $arResult['PROPERTIES']['SIZE_CHART']['VALUES_LIST']){
                                                    ?><span class="size_select get_medi_popup_Window" data-id="<?=$arResult['PROPERTIES']['SIZE_CHART']['VALUE']?>" data-title="Подбор размера" data-img = "<?=$arResult['PROPERTIES']['SIZE_CHART']['VALUES_LIST']['IMG']['SRC'] ?>">подобрать размер</span><?
                                                    }
                                                ?></div>
                ...
                <div id="tech">
                     <h2 class="heading"><?=GetMessage("CATALOG_ELEMENT_TECH_HEADING") ?></h2>
                        ...
                        {?>
                         <div class="techItem"><img src="<?=$tech['IMG']['src']; ?>" title="<?=$tech['UF_NAME']; ?>" class="question" data-description="<?=htmlspecialchars($tech['UF_FULL_DESCRIPTION']); ?>" /></div>
                        <?}
                        ?>
                        </div>
                </div>
