...
<html xmlns:v="urn:schemas-microsoft-com:vml"
    ...
    <head>
        ...
        <style>
            ...
            .product-table td {padding: 6px; border-bottom: 1px solid #000; border-left: 1px solid #000;}
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0"  style="font-size: 16px;">
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="5" style="height: 24px; font-size: 24px;">Заказ №<?= $arOrder["ACCOUNT_NUMBER"]; ?> на доставку [www.medi-salon.ru]</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="5"><div class="blank"><?= $arOrderProps['FIO'] ? $arOrderProps['FIO'] : '&nbsp;'; ?></div></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td colspan="2"><div class="blank"><?= $arOrderProps['PHONE'] ? $arOrderProps['PHONE'] : '&nbsp;'; ?></div></td>
                ...
                <tr>
                    ...
                    <td colspan="5"><div class="blank"><?= $arOrderProps['DISCOUNT_TYPE'] ? $arOrderProps['DISCOUNT_TYPE'] : '&nbsp;'; ?></div></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td colspan="3"><div class="blank"><?= $arOrderProps['DC_NUMBER'] ? $arOrderProps['DC_NUMBER'] : '&nbsp;'; ?></div></td>
                    <td style="height: 24px; font-weight: bold;" class="td1">&nbsp;&nbsp;&nbsp;Рецепт:</td>
                    <td ><div class="blank"><?= $arOrderProps['R_NUMBER'] ? $arOrderProps['R_NUMBER'] : '&nbsp;'; ?></div></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                ...
                <tr>
                    ...
                    <td> <div class="blank" style="text-align: center;"><?= $arOrderProps['DELIVERY_PLANNED'] ? $arOrderProps['DELIVERY_PLANNED'] : '&nbsp;'; ?>
					<br/>
                ...
                <tr>
                    ...
                    <td ><div class="blank" >&nbsp;<?=$arOrderProps['RESERV_NUMBER'];?></div></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
...
_c($arBasket);
                        if ($arBasket['CUSTOM_PRICE'] == 'N'){
                            ...
                            {
                                $full_price = number_format($arBasket["BASE_PRICE"], 2, ',', ' ');
                                $discount_price = round(($arBasket["BASE_PRICE"] - $arBasket["PRICE"])*100/(($arBasket["BASE_PRICE"] - $arBasket["PRICE"]) + $arBasket["PRICE"]))."%";
                            }
                            else {
                                $full_price = number_format($arBasket["DISCOUNT_PRICE"] + $arBasket["PRICE"], 2, ',', ' ');
                    ...
                    //print_r($arBasket); ?>
                        <tr valign="top" style="font-size: 12px;">
                            ...
                            <td class="td6"><?= $arBasket['QUANTITY']; ?></td>
                            <td class="td2" style="text-align: right; white-space: nowrap;">
                    ...
                    <tr valign="top" style="font-size: 12px;">
                        ...
                        <td style="text-align: right;">
                            <?= number_format(floor ($arOrder["PRICE_DELIVERY"]), 2, ',', ' '); ?>
                        </td>
                    </tr>
                    <tr valign="top" style="font-size: 12px;">
                        <td colspan="5" style=" border-bottom: 1px solid transparent; border-left: 1px solid transparent; text-align: right; background-color: #ddd; font-weight: bold;">Всего:</td>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0"  style="font-size: 16px;" width="745" style="width:745px;">
                <tbody>
                    <tr>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="5" style="height: 24px; font-size: 24px; width: 617px;">Заказ №<?= $arOrder["ACCOUNT_NUMBER"]; ?> / Габаритные размеры</td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                    </tr>
                ...
                <tbody>
                    ...
                    <? foreach ($arBasketOrder as $arBasket): ?>
                        ...
                        <tr valign="top" style="font-size: 12px;">
                            ...
                            <td class="td7" style="text-align: right; white-space: nowrap;"><?= $arBasket['QUANTITY']; ?></td>
                    ...
                    <? endforeach; ?>
                    <tr valign="top" style="font-size: 12px;">
                        <td colspan="4" style=" border-bottom: 1px solid transparent; border-left: 1px solid transparent; text-align: right; background-color: #ddd; font-weight: bold;">Вес всего заказа (гр):</td>
                        <td style="background-color: #ddd; text-align: right; border-bottom: 1px solid transparent;">
