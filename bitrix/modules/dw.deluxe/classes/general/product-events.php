...
class DwProductEvents
{
    ...
    public static function productAfterSave($arg1, $arg2 = false)
    {
        ...
        if (!empty($arTemplateSettings)) {
            ...
            //auto available
            //self::availableAutoUpdate($arg1, $arg2, $arTemplateSettings);
    ...
    //auto available system
    public static function availableAutoUpdate($arg1, $arg2 = false, $arTemplateSettings = array())
    {
        ...
        //check active option
        if (!empty($arSettings["TEMPLATE_USE_AUTO_AVAILABLE_PRODUCTS"]) && $arSettings["TEMPLATE_USE_AUTO_AVAILABLE_PRODUCTS"] == "Y") {
            ...
            if ($ELEMENT_ID) {
                ...
                if ($arPropCache[$IBLOCK_ID]) {
                    ...
                    foreach ($arProductID as $productID) {
                        ...
                        //get price
                        $arDiscountPrice = CCatalogProduct::GetOptimalPrice($productID, 1, $USER->GetUserGroupArray(), false, $priceIterator->fetchAll(), $arCatalog["LID"]);
