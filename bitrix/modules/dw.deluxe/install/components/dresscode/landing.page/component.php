<?
	...
	//current url
	$curPageUrl = $APPLICATION->GetCurPageParam("", array("sort_field", "sort_to", "view", "clear_cache", "bitrix_include_areas", "set_filter", "show_page_exec_time", "show_include_exec_time", "show_sql_stat"), false);
