...
class DwItemInfo{
    ...
    public static function get_more_pictures($pictureID, $arResizeParams, $arPushImage = array()){
        ...
        $arPushImage["MEDIUM_IMAGE"] = array_change_key_case(CFile::ResizeImageGet($pictureID, array("width" => $arResizeParams["MEDIUM_PICTURE"]["WIDTH"], "height" => $arResizeParams["MEDIUM_PICTURE"]["HEIGHT"]), BX_RESIZE_IMAGE_PROPORTIONAL, false), CASE_UPPER);  
        $arPushImage["LARGE_IMAGE"] = array_change_key_case(CFile::ResizeImageGet($pictureID, array("width" => $arResizeParams["LARGE_PICTURE"]["WIDTH"], "height" => $arResizeParams["LARGE_PICTURE"]["HEIGHT"]), BX_RESIZE_IMAGE_PROPORTIONAL, false), CASE_UPPER);  
        return $arPushImage;
    }
