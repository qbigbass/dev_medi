...
class CBitrixXscanFork
{
    ...
    public $false_positives = ['b4cd0dcca178dbc12935e505860864ad', 'f9577fd4ffb4024a8b1c7a63247e52e7', 'cc6969f6a56325d5676bc02a268057f8',
        ...
        '7c60ccaee2b919c9e6b16b307eb80dab', '77cdd8164d4940cb6bfaac906383a766', '5b3425a6ff518fa2337b373e1c799959'];
...
//				echo $var." => ".$p."<br>";
    ...
    function Search($path, $mode='search')
    {
        ...
        if ($mode == 'search' && $this->start_time && time() - $this->start_time > $this->time_limit) {
            if (!$this->break_point)
