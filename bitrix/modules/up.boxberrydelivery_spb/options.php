...
require_once($_SERVER['DOCUMENT_ROOT'].'/bitrix/modules/'.$module_id.'/classes/general/CModuleOptions_spb.php');
...
if($RIGHT != "D"){
    $opt = new CModuleOptions_spb($module_id, $arTabs, $arGroups, $arOptions, true);
    $opt->ShowHTML();
}
?>
