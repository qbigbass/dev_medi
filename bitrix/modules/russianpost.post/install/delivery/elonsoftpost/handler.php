...
class ElonsoftpostHandler extends \Bitrix\Sale\Delivery\Services\Base
{
	...
	protected static function getPostProfiles()
	{
		return array(
			...
			"5" => array(
				"ID" => "5",
				"CODE" => "POST_DOC",
				"Name" => Loc::getMessage('SALE_DLV_ELONSOFT_POST_PVZ_DOC'),
				"ShortDescription" => Loc::getMessage('SALE_DLV_ELONSOFT_POST_PVZ_DOC'),
				"Description" => Loc::getMessage('SALE_DLV_ELONSOFT_POST_PVZ_DOC'),
			),
		);
	}
	...
	public static function onAfterAdd($serviceId, array $fields = array())
	{
		...
		$result = true;
		//add logotip
		$arFile = \CFile::MakeFileArray('/bitrix/php_interface/include/sale_delivery/elonsoftpost/main.png');
		$arFileds1 = \CFile::SaveFile($arFile, "sale/delivery/logotip");
