		...
		return '
			...
			<table class="edit-table">
				...
				'.'<tr>
					...
					<td><select  name="FORM_PROD_BASKET_NOTES" id="FORM_PROD_BASKET_NOTES"  tabindex="6"><option></option><option value="novat">Без НДС</option><option value="vat0">НДС 0%</option><option value="vat10" selected="true">НДС 10%</option><option value="vat20">НДС 20%</option></select></td>
				</tr>'
				/*'<tr>
					<td class="adm-detail-content-cell-l">'.Loc::getMessage("SALE_ORDER_BASKET_PROD_EDIT_ITEM_NOTES").':</td>
