...
<? Tabs::showSelectBoxRow('TF_LOCATION_SHOW_CONFIRM_POPUP'); ?>
...
<tr>
    <td width="40%" class="adm-detail-content-cell-l adm-detail-content-text" >
        <label for="TF_LOCATION_CONFIRM_POPUP_RADIUS"><?=Loc::getMessage('tfl__' . Options::LIST_DESKTOP_RADIUS) ?>:</label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r">
        ...
        <div class="tfl-help"><?= Loc::getMessage('tfl__' . Options::LIST_DESKTOP_RADIUS . '_help')?></div>
    </td>
</tr>
<tr>
    <td colspan="2">
