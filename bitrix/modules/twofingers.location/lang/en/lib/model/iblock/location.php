...
$MESS['TFL_IBLOCK_PROP_' . Location::PROPERTY_SITE_ID]              = 'Сайт';
$MESS['TFL_IBLOCK_PROP_' . Location::PROPERTY_SITE_ID . '_HINT']    = 'Если не указан, местоположение будет доутупно на всех сайтах';