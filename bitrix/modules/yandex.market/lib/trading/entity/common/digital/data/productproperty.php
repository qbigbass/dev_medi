...
class ProductProperty
{
	...
	protected function iblockElementProperty(array $iblockElement, $code, array $property)
	{
		$propertyValues = [];
		...
		if (!isset($propertyValues[$iblockElement['ID']][$property['ID']]))
		{
		...
		$property = $propertyValues[$iblockElement['ID']][$property['ID']];
