...
$MESS['YANDEX_MARKET_COMPONENT_TRADINGIMPORT_EDITFORM_FIELD_USE_STORE_GROUP'] = 'Объединить остатки для&nbsp;кампаний';
$MESS['YANDEX_MARKET_COMPONENT_TRADINGIMPORT_EDITFORM_FIELD_USE_STORE_GROUP_HELP'] = 'Если ваши товары физически хранятся на&nbsp;одном складе, а&nbsp;на&nbsp;Маркете продаются с&nbsp;нескольких, объедините такие <a href="https://market.yandex.ru/partners/news/zagruzhayte-ostatki-na-neskolko-skladov-srazu" target="_blank">склады в&nbsp;группу</a>.';
...
';
$MESS['YANDEX_MARKET_COMPONENT_TRADINGIMPORT_EDITFORM_SUCCESS_STORE_GROUP'] = '<p>После создайте группу складов в разделе Логистика &rarr; Склады.</p>';
