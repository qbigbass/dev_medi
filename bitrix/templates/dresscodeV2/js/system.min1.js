...
$(".itemCard a.name, .itemCard a.picture").click(function(){ clickEventPush($(this));});
...
if(productID){
$.ajax({
url: ajaxPath + "?act=getFastView&product_id=" + productID + "&product_iblock_id=" + productIblockID + "&product_currency_id=" + $productContainer.data("currency-id") + "&product_convert_currency=" + $productContainer.data("convert-currency") + "&product_price_code=" + $productContainer.data("price-code") + "&product_hide_measures=" + $productContainer.data("hide-measure") + "&product_hide_not_available=" + $productContainer.data("hide-not-available") + "&product_pos="+productListPos,
...
.prepend($("<img />").attr({src: TEMPLATE_PATH + "/images/added.png", class: "icon"})).attr("id", "GTM_go_cart_card");
}else{
$changeCart.removeClass("disabled").removeClass("requestPrice")
...
$(".qtyBlock").hide();
$changeCart.html("Заказать").prepend(
...
$elPicture.html($("<img/>").attr("src", http[0]["PRODUCT"]["PICTURE"]));
$elPicture.append($("<span />", {class: "getFastView"}).data("id", http[0]["PRODUCT"]["ID"]).html(LANG["FAST_VIEW_PRODUCT_LABEL"]));
$_mProduct.find(".addCart, .fastBack, .addCompare, .changeCart").data("id", http[0]["PRODUCT"]["ID"]).attr("data-id", http[0]["PRODUCT"]["ID"]);
if(http[0]["PRODUCT"]["PRICE"]["DISCOUNT_PRICE"]){
...
$_mProduct.find(".changeCart").html("В корзину").prepend(
$("<img/>").addClass("icon").attr("src", TEMPLATE_PATH + "/images/incart.png"))
.attr("href", "#").removeClass("disabled").removeClass("label").removeClass("fastBack").addClass("addCart");
}
else {
$(".qtyBlock").hide();
$changeCart.html("Заказать").prepend(
$("<img/>").addClass("icon").attr("src", TEMPLATE_PATH + "/images/incart.png"))
.attr("href", "#").removeClass("addCart").addClass("fastBack label changeCart");
}
}else{
if(http[0]["PRODUCT"]["CAN_BUY"] != "Y"){
$changeAvailable.html(LANG["CATALOG_NO_AVAILABLE"]).addClass("outOfStock");
...
'currencyCode': 'RUB',
'purchase': {
'actionField': {'id': 'order'+jData['result_id'], 'coupon':'', 'affiliation':'Заказное изделие'},
'products': [{
'name': jData['product']['name'],
'id': jData['product']['id'],
...
$topMenuContainer.removeClass("fixed");topMenuFixed = false;
}
};
