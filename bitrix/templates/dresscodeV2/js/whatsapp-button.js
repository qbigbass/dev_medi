(function () {
    ...
    (WASHAREBTN.prototype.isIos = navigator.userAgent.match(/Android|iPhone/i) && !navigator.userAgent.match(/iPod|iPad/i) ? !0 : !1),
        ...
        (WASHAREBTN.prototype.crBtn = function () {
            for (var b = [].slice.call(document.querySelectorAll(".wa_btn")), iframes = [], i = 0; i < b.length; i++)
                root.WASHAREBTN.buttons.push(b[i]), (b[i] = root.WASHAREBTN.setButtonAttributes(b[i])), (iframes[i] = root.WASHAREBTN.setIframeAttributes(b[i])), b[i].parentNode.insertBefore(iframes[i], b[i]);
        }),
