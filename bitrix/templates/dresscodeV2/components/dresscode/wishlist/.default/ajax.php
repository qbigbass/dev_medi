			...
			if(!empty($_GET["email"]) && !empty($_GET["siteID"])){
				...
				if(!empty($_SESSION["WISHLIST_LIST"]["ITEMS"])){
					...
					if(empty($postMess)){
						...
						$MESSAGE = '<div style="background-color:#e4e7ed;padding-top:24px;padding-bottom:24px;margin:0;font-family:\'Arial\',sans-serif;">
							<div style="min-width:600px;max-width:600px;margin:auto;">
								...
								<div style="padding-top:24px;padding-right:24px;padding-bottom:30px;padding-left:24px;margin-top:12px;background-color:#ffffff;">
									...
									<table width="100%" cellpadding="0" cellspacing="0" border="0">
										<tbody>
											<tr>
												<td style="width:50%;padding-top:18px;padding-bottom:18px;text-align:center;border-right:5px solid #fff;text-align:center;background:#e4e7ed;">
												...
												<td style="width:50%;padding-top:18px;padding-bottom:18px;text-align:center;border-left:5px solid #fff;text-align:center;background:#e4e7ed;">
