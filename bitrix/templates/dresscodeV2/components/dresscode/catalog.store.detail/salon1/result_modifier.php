        ...
        if (in_array($arEnum['ID'], $services))
        {
            $ObLinks = CIBlockElement::GetList(
              ...
              ["IBLOCK_ID"=>11, "PROPERTY_STORE_SERVICES_NAME_VALUE"=>$arEnum['VALUE']],
               false,  false,
               ["ID","NAME", "DETAIL_PAGE_URL", "PREVIEW_TEXT", "PREVIEW_PICTURE", "SORT", "PROPERTY_STORE_SERVICE_NAME"]
             );
...
$this->__component->SetResultCacheKeys(array(
   "WORK_STR",
   "WORKING",
   "UF_STORE_META_DECRIPTION",
   "UF_STORE_PUBLIC_NAME",
   "UF_STORE_META_KEYWORDS"
