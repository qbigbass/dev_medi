    ...
    <div class="elementProperties">
        ...
        <div class="propertyList">
            <?foreach ($arResult["DISPLAY_PROPERTIES"] as $ip => $arProperty):
                if (in_array($arProperty['CODE'], ['PRODUCT_TYPE_GROUP', 'PRODUCT_TYPE_LINK'])) continue;?>
                    ...
                    <div class="propertyTable">
                        ...
                        <div class="propertyValue">
                            <?if($arProperty["PROPERTY_TYPE"] == "E" || $arProperty["PROPERTY_TYPE"] == "S"):?>
                                <?if ($arProperty['LINK_ELEMENT_VALUE']){
                                    foreach ($arProperty['LINK_ELEMENT_VALUE'] as $key => $value) {
                                        $lname = $value['NAME'];
                                    }
                                    echo $lname;
                                }else{
