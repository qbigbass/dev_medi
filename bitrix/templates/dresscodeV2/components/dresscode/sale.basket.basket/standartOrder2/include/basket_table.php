<table class="productTable">
	...
	<tbody>
		...
		<?$countPos += $arElement["QUANTITY"] ?>
			<tr class="basketItemsRow parent item" data-product-iblock-id="<?=$arElement["IBLOCK_ID"]?>" data-id="<?=$arElement["ID"]?>" data-cart-id="<?=$arElement["ID"]?>"  data-position="<?=$pos?>"  data-product-price="<?=$arElement['PRICE'];?>"  data-product-category="<?=$arElement['product']['CATEGORY'];?>" data-product-articul="<?=$arElement['PROPERTIES']['CML2_ARTICLE']['VALUE'];?>" data-product-brand="<?=$arElement['product']['BRAND'];?>"     data-product-name="<?=($arElement['product']['NAME'] ? $arElement['product']['NAME'] :  $arElement['NAME']);?>"  data-product-id="<?=($arElement['product']['ID'] ? $arElement['product']['ID'] :  $arElement['ID']);?>">
				<td>
