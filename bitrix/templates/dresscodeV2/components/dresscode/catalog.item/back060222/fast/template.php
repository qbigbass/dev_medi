				...
				<div class="appFastViewInformationColumn">
					...
					<?if(!empty($arResult["PRICE"])):?>
						...
						<?else:?>
							...
							<a href="#" class="addCart" data-id="<?=$arResult["ID"]?>"  id="GTM_add_cart_fast" ><img src="<?=SITE_TEMPLATE_PATH?>/images/incart.png" alt="" class="icon"><?=GetMessage("FAST_VIEW_ADDCART_LABEL")?></a>
							<?endif;?>
						<?endif;?>
					<?else:?>
