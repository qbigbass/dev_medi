...
<div id="<?= $this->GetEditAreaId($arResult["ID"]); ?>">
    ...
    <div id="catalogElement" class="item<? if (!empty($arResult["SKU_OFFERS"])): ?> elementSku<? endif; ?>"
         ...
         data-section="<?= $arResult["PARENT_PRODUCT"]["IBLOCK_SECTION_ID"] ?>" data-offerid="<?= $arResult["ID"] ?>">
                    ...
                    <div class="secondCol col<? if (empty($arResult["PREVIEW_TEXT"]) && empty($arResult["SKU_OFFERS"]) && empty($arResult["PROPERTIES"])): ?> hide<? endif; ?>">
                                ...
                                <? } elseif ($arResult['BRAND_ACTIVE'] == 'Да') { ?>
                                    <a href="<?= $arResult["BRAND"]["DETAIL_PAGE_URL"] ?>" class="brandImage">
                                        <img src="<?= $arResult["BRAND"]["PICTURE"]["src"] ?>"
                                             alt="<?= $arResult["BRAND"]["NAME"] ?>"></a>
                                <? } else { ?>
                                    <span class="brandImage"><img src="<?= $arResult["BRAND"]["PICTURE"]["src"] ?>"
                        ...
                        <? if (!empty($arResult["SKU_OFFERS"])): ?>
                            <? if (!empty($arResult["SKU_PROPERTIES"]) && $level = 1): ?>
                                ...
                                $sizechart = 0;
                                $sizechart_name = 'таблица размеров';
                                if (in_array($arResult["PARENT_PRODUCT"]["IBLOCK_SECTION_ID"], [84, 85, 86, 87])) {
                                    $sizechart_name = 'подбор размера';
                                }
                                ?>
                                                        ...
                                                        if ($arResult['PROPERTIES']['SIZE_VIDEO']) {
                                                            ...
                                                            <nobr class="video_size_select"><span
                                                                    ...
                                                                    data-video="<?= $arResult['PROPERTIES']['SIZE_VIDEO'] ?>"><img
                                                                        style="transform: translateY(6px); margin-right: 7px;"
                                                                        width="20px"
                                                                    ...
                                                                    id="GTM_size_videomap">как снять мерки</span></nobr>
                                                            <?
                                                        }
                                                    }
                                                    ?>
	...
	false
                            ...
                            <div class="items sz<?= (count($arResult["VIDEO"]) > 2 ? '3' : '2') ?>">
                                <? foreach ($arResult["VIDEO"] as $ivp => $videoValue): ?>
                                    <div class="item">
                                        ...
                                        ?>
                                        <iframe src="<?= $videoValue ?>?rel=0" allowfullscreen
                    ...
                    <div id="tech">
                        ...
                        <div class="techList">
                            <? foreach ($arResult['PROPERTIES']['TECHNOLOGIES']['VALUES_LIST'] as $p => $tech) {
                                ?>
                                <div onfocus="focusClick()" onfocusout="focusOutClick()" tabindex="0"
                                     class="tooltip techItem">
                                            ...
                                            <div class="item">
                                                <div class="tb">
                                                    <div class="tbr">
                                                        ...
                                                        <div class="info">
                                                            <a href="<?= $arFile['FILE']["SRC"] ?>" class="name"
                                                               target="_blank"
                                        ...
                                        <div class="item">
                                            <div class="tb">
                                                <div class="tbr">
                                                    ...
                                                    <div class="info">
                                                        <a href="<?= $arDocs['FILE']["SRC"] ?>" class="name"
                                                           target="_blank"
                ...
                <? if (isset($arResult["REVIEWS"])): ?>
                    <div id="catalogReviews">
                        <h2 class="heading"><?= GetMessage("REVIEW") ?> (<?= count($arResult["REVIEWS"]) ?>
                            ) <? if ($arParams["SHOW_REVIEW_FORM"]): ?><a href="#"
                                                                          class="reviewAddButton"><?= GetMessage("REVIEWS_ADD") ?></a><? endif; ?>
                        </h2>
                        <ul id="reviews">
                        ...
                        <? if (count($arResult["REVIEWS"]) > 1): ?><a href="#" id="showallReviews"
                                                                      data-open="N"><?= GetMessage("SHOWALLREVIEWS") ?></a><? endif; ?>
                    </div>
                            ...
                            <form action="" method="GET">
                                ...
                                <div class="newReviewTable">
                                        ...
                                        <? if (!empty($arResult["NEW_REVIEW"]["EXPERIENCE"])): ?>
                                            <ul class="usedSelect">
                                                <? foreach ($arResult["NEW_REVIEW"]["EXPERIENCE"] as $arExp): ?>
                                                    <li><a href="#"
                                                           data-id="<?= $arExp["ID"] ?>"><?= $arExp["VALUE"] ?></a></li>
                                                <? endforeach; ?>
                                            </ul>
                                        <? endif; ?>
                                    ...
                                    <div class="right">
                                        ...
                                        <input type="text" name="NAME" maxlength="50" required><a href="#"
                                                                                                  class="submit"
