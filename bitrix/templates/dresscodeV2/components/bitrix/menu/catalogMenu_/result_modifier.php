<?
	...
	if($obCache->InitCache(10, SITE_ID."v2.26", "/")){
	...
	elseif($obCache->StartDataCache()){
		...
		if(!empty($arResult)){
			...
			foreach($arResult as $k => $arElement){
			    ...
			    false,
			        ["ID","UF_REGIONS", "UF_MENU_TMPL", "UF_MENU_IMG", "UF_ADDLINK", "UF_ADDPHOTO", "UF_ADDNAME"]
			    );
			...
			false,
				["ID", "NAME", "DEPTH_LEVEL", "UF_ICON", "UF_ADDITIONAL", "UF_CATLINK", "UF_LINK"]
			);
