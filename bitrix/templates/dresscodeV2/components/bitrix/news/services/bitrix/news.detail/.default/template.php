...
<?if(!empty($arResult)):?>
	...
	if(!empty($arResult["PROPERTIES"]["BG_IMG_DETAIL"])){
	    $arResult["PROPERTIES"]["BG_IMG_DETAIL"] = CFile::ResizeImageGet($arResult["PROPERTIES"]["BG_IMG_DETAIL"]["VALUE"], array("width" => 1920, "height" => 480), BX_RESIZE_IMAGE_PROPORTIONAL, false, false, false, 95);
	}
	?>
	<?//include view?>
	...
	<?elseif(!empty($arResult["PROPERTIES"]["BG_IMG_DETAIL"])):?>
		<meta property="og:image" content="<?=$arResult["PROPERTIES"]["BG_IMG_DETAIL"]["src"]?>" />
	<?endif;?>
<?endif;?>
