...
if (!empty($arResult['PROPERTIES']['REDIRECT']['VALUE'])){
	LocalRedirect($arResult['PROPERTIES']['REDIRECT']['VALUE'], fales, '301');
}
...
elseif(!empty($arResult["PREVIEW_TEXT"])):
	$APPLICATION->AddHeadString('<meta property="og:description" content="'.strip_tags(html_entity_decode(str_replace("&nbsp;", " ", $arResult["PREVIEW_TEXT"]), ENT_QUOTES)).'" />');
endif;
