...
(function () {
    ...
    BX.Sale.OrderAjaxComponent = {
        ...
        refreshOrder: function (result) {
            ...
            if ($("#salon_name_field").length) {
                ...
                $str = '<div class="form-group bx-soa-customer-field" data-property-id-row="50">' +
                    ...
                    ' id="soa-property-50" placeholder="" value="' + $client.data('consult') + '" class="form-control ' +
                ...
                $str2 = '<div class="form-group bx-soa-customer-field" data-property-id-row="52">' +
                    ...
                    'bx-ios-fix" value="' + $client.data('date-val') + '" name="ORDER_PROP_52-inp"' +
                    ' id="soa-property-52-inp"/></div></div>';
        ...
        createBasketItemImg: function (data) {
            ...
            if (this.params.HIDE_DETAIL_PAGE_URL !== 'Y' && data.DETAIL_PAGE_URL && data.DETAIL_PAGE_URL.length) {
                logoNode = BX.create('A', {
                    ...
                    attrs: {'target': '_blank', 'data-id': data.PRODUCT_ID},
                    children: [logoNode]
                });
            }
        ...
        createBasketItemContent: function (data) {
            ...
            if (this.params.HIDE_DETAIL_PAGE_URL !== 'Y' && data.DETAIL_PAGE_URL && data.DETAIL_PAGE_URL.length) {
                titleHtml = '<a href="' + data.DETAIL_PAGE_URL + '" data-id="' + data.PRODUCT_ID + '" target="_blank">' + titleHtml + '</a>';
            }
