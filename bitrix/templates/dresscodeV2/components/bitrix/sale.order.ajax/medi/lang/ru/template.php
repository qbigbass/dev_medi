...
$MESS["SOA_ORDER_SUC1"] = "Вы можете следить за выполнением своего заказа в <a href=\"#LINK#\">Личном кабинете</a>. Обратите внимание, что для входа Вам необходимо будет ввести логин и пароль пользователя интернет-магазина.";
...
$MESS["SOA_ORDER_COMPLETE"] = "Спасибо за заказ!";
