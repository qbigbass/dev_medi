...
<div class="bx-auth">
	...
	<?else:?>
		...
		<div class="bx-auth-forgot-buttons">
			<a href="<?=SITE_DIR?>salons/auth/?change_password=yes" class="btn-simple btn-small bx-auth-change-password-link"><?=GetMessage("AUTH_WRITE_STRING")?></a>
			<a href="<?=SITE_DIR?>salons/auth/" class="btn-simple btn-small btn-black-border"><?=GetMessage("AUTH_TITLE")?></a>
		</div>
	<?endif;?>
