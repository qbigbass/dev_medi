            ...
            <? foreach ($arCategory["ITEMS"] as $i => $arItem): ?>
                <? if (isset($arResult["SECTIONS"][$arItem["ITEM_ID"]])):
                    ...
                    <a class="js_search_href bx_item_block_href bx_item_block_section" href="<? echo $arItem["URL"] ?>">
                        <? if ($preview): ?>
                            <span class="bx_item_block_item_image" style="<?= $image_style ?>"><img
                                        src="<?= $image_url ?>" alt=""></span>
                        <? endif; ?>
									...
									<? if (!empty($arElement["PROPS"])): ?>
                                        <span class="bx_item_block_item_props">
											<? foreach ($arElement["PROPS"] as $prop):
                                                ...
                                                ?>
                                                <span class="bx_item_block_item_prop_item"><span
                                                            class="bx_item_block_item_prop_item_name"><?= $prop["NAME"] ?>:</span> <span
                                                            class="bx_item_block_item_prop_item_value"><?
                ...
                <? if ($category_id === "all"): ?>
                    <div class="js_search_href bx_item_block all_result">
                        <div class="js_search_href bx_item_element bx_item_element_all_result">
                            <a class="js_search_href all_result_button"
                               href="<? echo $arItem["URL"] ?>"><? echo $arItem["NAME"] ?></a>
                        </div>
