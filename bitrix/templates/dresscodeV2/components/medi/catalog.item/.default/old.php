					...
					<?if(!empty($arResult["PRICE"])):?>
						...
						<?if($arResult["CATALOG_AVAILABLE"] != "Y"):?>
							...
							<?if($arResult["CATALOG_SUBSCRIBE"] == "Y"):?>
								<a href="#" class="fastBack fastBut addOrder <?if(empty($arResult["PRICE"])):?> disabled<?endif;?>" data-id="<?=$arResult["ID"]?>"><img src="<?=SITE_TEMPLATE_PATH?>/images/incart.png" alt="<?=GetMessage("ORDER_NOTAVAIL_LABEL")?>" class="icon"><?=GetMessage("ORDER_NOTAVAIL_LABEL")?></a>
							<?else:?>
								...
								<a href="#" class="fastBack fastBut label changeID " data-id="<?=$arResult["ID"]?>"><img src="<?=SITE_TEMPLATE_PATH?>/images/incart.png" alt="<?=GetMessage("ORDER_NOTAVAIL_LABEL_ALT")?>" class="icon"><?=GetMessage("ORDER_NOTAVAIL_LABEL")?></a>
								<?else:?>
						...
						<?else:?>
							...
							<?/*
							<a href="#" class="addCart changeCart" data-id="<?=$arResult["ID"]?>"  id="GTM_add_cart_catalog_<?=($arParams['LIST_TYPE'] ? $arParams['LIST_TYPE'].'_' : '' )?><?=$arParams['POS_COUNT']?>_<?=$arResult["ID"]?>"><img src="<?=SITE_TEMPLATE_PATH?>/images/incart.png" alt="<?=GetMessage("ADDCART_LABEL")?>" class="icon" ><?=GetMessage("ADDCART_LABEL")?></a>
							*/?>
							<?else:?>
								<?// Сканирование стоп, основная кнопка?>
								<?if ($arResult['DISPLAY_BUTTONS']['INSOLE_BUTTON']):?>
