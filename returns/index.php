    ...
    <div class="global-block-container">
        <div class="global-content-block">
            <div class="detail-text-wrap">
                ...
                <p class="ff-medium">Товар принимается в сухом и чистом виде.</p>
                <p>
                ...
                <div class="white-bg" style="padding-top: 20px;padding-bottom: 20px;">
                    ...
                    <div class="flex">
                        ...
                        <div class="flex-item">
                            ...
                            <p>Для возврата товаров, приобретенных в салоне пр-т Мира дом 55 стр.1,<br>
                                возврат оформляется в  <a href="/salons/salon-medi-taganskaya/" target="_blank" class="theme-link-dashed">салоне Таганская</a>
                            </p>
