...
<p>&nbsp;</p>
					...
					<div class="flex-item">
						...
						<a href="/ekb/salons/" target="_blank" class="theme-link-dashed">Адреса и&nbsp;график работы салонов medi.</a>
					</div>
				</div>
				<br>
				...
				<blockquote>
					<p>После оформления заявления на&nbsp;возврат или&nbsp;обмен, специалисты компании проведут экспертизу качества изделия и&nbsp;сообщат вам о&nbsp;ее результатах: в&nbsp;случае выявления заводского брака или&nbsp;дефекта, вам будет предложена замена товара или&nbsp;будет возвращена стоимость, по&nbsp;которой вы&nbsp;его приобрели</p>
				</blockquote>
			</div>
		</div>
	</div>
