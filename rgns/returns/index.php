...
<p>&nbsp;</p>
						<p>
							 Для клиентов из регионов, просьба, разборчиво заполнить заявления, выслать копию нам на почту <a href="mailto:mks@mediexp.ru">mks@mediexp.ru</a> для проверки правильности заполнения. <span class="ff-medium">Дождаться подтверждения</span> проверки, затем оригинал заявлений отправить вместе с изделием.
						</p>
						<ul>
...
<br>
				...
				<p class="h3 ff-medium"><span class="medi-color ff-bold" style="font-size: 1.3em;">4.</span>&nbsp;&nbsp;Дождитесь результатов проверки</p>
				<blockquote>
