		...
		<div class="tabs-wrap">
			<div class="tabs-links flex">
				<div class="tab-link tab-dostavka active">
					...
					<p class="h3">Доставка курьером СДЭК</p>
				</div>
							...
							<div class="flex-item">
								<table>
									...
									<tr>
										<td>
<p>
											 –&nbsp;<span class="medi-color">Бесплатная доставка</span>&nbsp;– при&nbsp;сумме покупки свыше 4&nbsp;490&nbsp;рублей;</p>
											<p>Вы&nbsp;сможете выбрать курьерскую службу в&nbsp;процессе оформления заказа. Курьер доставит ваш заказ по&nbsp;указанному адресу в&nbsp;удобное для вас время.</p> 

<p>											 –&nbsp;<span class="medi-color">Стоимость доставки зависит от&nbsp;веса заказанных товаров и&nbsp;от&nbsp;региона, и&nbsp;будет рассчитана автоматически в&nbsp;процессе оформления заказа</span>&nbsp;– если сумма вашей покупки менее 4&nbsp;490&nbsp;рублей.
										</p>
										</td>
									</tr>
								</table>
