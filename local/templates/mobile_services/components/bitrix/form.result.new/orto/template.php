        ...
        <div class="order-form__product">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="two columns">
                        <label for="order-form__client-weightheight">Рост/Вес:</label>
                        <input id="order-form__client-weightheight" class="u-full-width" type="text" name="form_text_81" value="<?= empty($arResult['arrVALUES']['form_text_81']) ? '' : $arResult['arrVALUES']['form_text_81']; ?>">
                    </div>
                    <div class="six columns">
            ...
            <div class="container">
                <div class="row">
                    <div class="five columns offset-by-seven">
                        ...
                        <input type="hidden" name="form_radio_type" value="102"/>
