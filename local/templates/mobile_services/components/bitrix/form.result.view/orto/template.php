        ...
        <div class="container">
            <div class="row">
                <div class="four columns">
                    ...
                    <input id="order-form__visit-date" class="u-full-width  datepicker" disabled type="text" name="form_text_130" value="<?= $arResult['RESULT']['visit_date']['ANSWER_VALUE'][0]['USER_TEXT'] ?>">
                </div>

                <div class="four columns">
                    <label for="order-form__title">Название ЛПУ:</label>
                    <input id="order-form__title" class="u-full-width " type="text" disabled name="form_text_128" value="<?= $arResult['RESULT']['title_lpu']['ANSWER_VALUE'][0]['USER_TEXT']; ?>">
                </div>
                <div class="four columns">
                    <label for="order-form__address">Адрес ЛПУ:</label>
                    <input id="order-form__address" class="u-full-width " type="text" disabled name="form_text_129" value="<?= $arResult['RESULT']['address_lpu']['ANSWER_VALUE'][0]['USER_TEXT']; ?>">
                </div>
            </div>
            ...
            <div class="row">
                <div class="twelwe columns">
                    ...
                    <textarea id="order-form__comment" class="u-full-width" disabled name="form_textarea_94"><?= $arResult['RESULT']['comment']['ANSWER_VALUE'][0]['USER_TEXT']; ?></textarea>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="seven columns">
                        <label for="order-form__comment">Комментарий:</label>
                        <textarea id="order-form__comment" rows="1" class="u-full-width" name="form_textarea_94" disabled><?= $arResult['RESULT']['comment']['ANSWER_VALUE'][0]['USER_TEXT']; ?></textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="twelve columns">
                        <label for="order-form__contact-address" class="order-form__label--truncate">Адрес клиента:</label>
                        <textarea id="order-form__contact-address" rows="1" class="u-full-width" name="form_textarea_95" disabled><?= $arResult['RESULT']['client_address']['ANSWER_VALUE'][0]['USER_TEXT']; ?></textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="order-form__product">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="four columns">
                        <input type="text" id="order-form__payment_type" class="u-full-width" name="form_dropdown_payment_type" value="<?= $arResult['RESULT']['payment_type']['ANSWER_VALUE'][0]['ANSWER_TEXT']; ?>" disabled>
