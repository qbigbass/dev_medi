...
<span id="result"></span>
	...
	<?endif;
		...
		<script >
				...
				document.location.href = "#result";
				waitForFbq(function () {
					fbq('track', 'SubmitApplication', {content_name: 'mtm'});
			    });
		</script>
...
<div class="form_footer">
	<div class="webFormTools">
		...
		<input type="submit" name="web_form_submit" id="GTM_web_form_SCAN" value="Записаться" class="sendWebFormDw" onsubmit="ym(30121774, 'reachGoal', 'scan_click'); return   true;">
