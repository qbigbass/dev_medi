...
<div class="form_reserve scan podolog">
...
<?
	foreach ($arResult["QUESTIONS"] as $FIELD_SID => $arQuestion)
	{
		...
		else
		{
            if (in_array($arQuestion['STRUCTURE'][0]['ID'], $arResult['HIDE_FIELDS'] )):
				...
				<div class="column">
                <div class="columnRow row">
    	            <div class="form_text_<?=$arQuestion['STRUCTURE'][0]['ID']?> webFormItemField salon_select">
						<?if(!empty($arQuestion["IMAGE"])):?>
							<?$imageCaption = CFile::ResizeImageGet($arQuestion["IMAGE"]["ID"], array("width" => 24, "height" => 24), BX_RESIZE_IMAGE_PROPORTIONAL, false);?>
							<img src="<?=$imageCaption["src"]?>" class="webFormItemImage" alt="<?=$arQuestion["CAPTION"]?>">
						<?endif;?>
						...
						<div tabindex="0" href="#" onfocus="focusClick();return false;" onfocusout="focusOutClick();return false;" class="tooltip">
							<div class="tooltip-text-focus ">
								<img onclick="closeTooltip();return false;" class="close-button" src="<?=SITE_TEMPLATE_PATH?>/images/clear.png">
								<div class="salon_form_desc">
									<div class="salon-contacts">
										<span class="salon-adres">ул. Дмитрия Ульянова, 16, к. 1 </span>
									</div>
									<div class="salon-shedule">
										<span class="salon-shedule">ежедневно с 9:00 до 21:00</span>
									</div>
								</div>
							</div>
							<div class="tooltip-text-hover ">
								<div class="salon_form_desc">
									<div class="salon-contacts">
										<span class="salon-adres">ул. Дмитрия Ульянова, 16, к. 1 </span>
									</div>
    	                ...
    	                $(document).ready(function() {
    	                    ...
    	                    function set_salon_info(){
    	                        ...
    	                        $(".salon_form_desc").html($salon_info);
    	                    }
	...
	<div class="webFormTools">
		<input <?=(intval($arResult["F_RIGHT"]) < 10 ? "disabled=\"disabled\"" : "");?> type="submit" name="web_form_submit" id="web_form_<?=$arResult["arForm"]["SID"]?>" value="<?=htmlspecialcharsbx(strlen(trim($arResult["arForm"]["BUTTON"])) <= 0 ? GetMessage("FORM_ADD") : $arResult["arForm"]["BUTTON"]);?>" class="sendWebFormDw"   />
