...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PROP_1" => "",
		"PROP_2" => "",
		"ALLOW_NEW_PROFILE" => "N",//$is_salon == 'Y' ? 'Y' : "N",
		...
		"SHOW_VAT_PRICE" => "Y",
		"COMPATIBLE_MODE" => "Y",
		"USE_PRELOAD" => $is_salon == 'Y' ? 'N' : "Y",
		"ALLOW_USER_PROFILES" =>  "N", //$is_salon == 'Y' ? 'Y' : "N",
		"TEMPLATE_THEME" => "site",
		...
		"MESS_PERIOD" => "Срок доставки, ориентировочно",
		"MESS_NAV_BACK" => "Назад",
		...
		"MESS_FAIL_PRELOAD_TEXT" => "Вы заказывали в нашем интернет-магазине, поэтому мы заполнили все данные автоматически.\r\nОбратите внимание на развернутый блок с информацией о заказе. Здесь вы можете внести необходимые изменения или оставить как есть и нажать кнопку \"#ORDER_BUTTON#\".",
		"MESS_DELIVERY_CALC_ERROR_TITLE" => "Не удалось рассчитать стоимость доставки, попробуйте снова или выберите другой вариант.",
