...
<div class="white-bg flex">
	...
	<div class="flex-item">
		...
		<ul class="galka">
			...
			<li>Узнать адрес нужного салона, график его работы и&nbsp;схему проезда в&nbsp;разделе <a style="font-size: 1em;" target="_blank" href="/rnd/salons/" class="theme-link-dashed">Салоны</a>;</li>
